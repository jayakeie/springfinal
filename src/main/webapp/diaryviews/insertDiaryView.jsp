...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="page-title">🌱 새로운 추억 기록하기</h2>
            
            <form action="insertDiaryProc.do" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="name" id="nameInput" placeholder="예: 뽀삐, 몬스테라, 지아" required maxlength="20">
                    <div class="form-text text-muted ms-1">오늘 기록할 대상의 이름을 적어 주세요.</div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" name="content" rows="8" placeholder="오늘 있었던 특별한 일을 기록해 보세요..." required></textarea>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="image-upload-area" id="uploadArea">
                        ...
                        <p class="mb-1 fw-bold text-muted">클릭하거나 사진을 이곳에 드래그하세요</p>
                    </div>
        ...
        function previewFile(file) {
            ...
            reader.onloadend = function() {
                ...
                div.querySelector('.remove-btn').onclick = function(e) {
                    e.stopPropagation();
                    div.remove();
                    //여기서는 화면에서만 지워지고 실제 전송 파일 리스트인 imageInput.files에서는 제거되지 않음 
                };
